...
import com.mycompany.ala.models.MaterialTableModel;
...
public class MaterialView extends javax.swing.JFrame {
     ...
     */
    public MaterialView(Reserv reserv) {
        
        initComponents();    
        tbMaterial.setModel(new MaterialTableModel(reserv));
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MaterialView(null).setVisible(true);
            }
        });
    }
